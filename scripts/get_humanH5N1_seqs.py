"""Parses sequences of human H5N1 influenza genes.

Gets the PB2, PA, NP, M1, M2, NS1, and NS2 coding sequences.
...
def main():
    ...
    # define variables
    max_per_year = 500 # keep <= this many strains per year
    musclepath = '/Users/jbloom/muscle3.8/'
    infile = 'humanH5N1.fasta' # input file of human genes
    outfile = 'humanH5N1_%s.fasta' # output file
    ...
    identity_cutoff = 0.80 # ignore strains with less than this much identity
